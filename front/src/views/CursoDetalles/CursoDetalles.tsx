   ...
   useEffect(() => {
      ...
      if (storedUserString) {
         ...
         if (localUser && localUser.id) {
            // Ensure localUser and localUser.id exist
            axiosInstance
               .get(`/users/${localUser.id}`) // Use the correct endpoint
               .then((response) => {
                     ...
                     <form onSubmit={handleSubmit}>
                        ...
                        >
                           ...
                           {[...Array(24)].map((_, hour) => {
                              ...
                              const shouldDisable =
                                 isToday &&
                                 hour < parseInt(minTime.slice(0, 2));
                              return (
                                 <option
                                    key={hour}
                                    value={hourStr}
                  ...
                  <section className="p-4">
                     ...
                     {curso.multimedia && curso.multimedia.length > 0 ? (
                        ...
                        <p className="text-center text-gray-600">
                           No hay contenido multimedia disponible para esta
                           clase.
                        </p>
                     )}
                  </section>
               ...
               {activeTab === 'reviews' && (
                  <div className="w-full h-full flex gap-4">
                     ...
                     <div className="w-1/2 bg-gray-200 me-6 rounded-md p-4">
                        ...
                        {(!userIsStudent || !userIsEnrolled) && (
                           <p className="text-center text-gray-600">
                              Debes ser un estudiante inscrito para dejar una
                              reseña.
                           </p>
                        )}
                     </div>
